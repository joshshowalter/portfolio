export default function Hero() {
  return (
    <section className="min-h-screen w-full flex flex-col items-start justify-center">
      ...
      <div className="">
        <p className="mt-12 max-w-prose">I am a full-stack software engineer with a specialization in Angular and React, creating intuitive, modern web applications. Currently building the central esports community plaform for casual gamers at Brag House.</p>
      </div>
    </section>
  );
}